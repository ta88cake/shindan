...
[SECTION_1]
「総合性格・運勢・仕事」に相当する部分（1400字以上）。
【数秘術によるあなたの運勢】【仕事と適性】のような見出しを本文中に含め、スコアの数値の意味を具体的に解釈する（例：RSが正なら「一人の時間を大切にし、深く考えてから話す傾向」など）。データ2・データ3の内容にも触れ、この人ならではの適性・人生の方向性・転機のようなものを段落で描写する。誰にでも言えるような一般論は書かない。

[SECTION_2]
「恋愛と人間関係」に相当する部分（1000字以上）。
【恋愛と人間関係】の見出しを本文中に含め、スコアとデータ3を根拠に、この人の恋愛のパターン・求めている関係・人との距離の取り方・パートナーに求めるものを具体的に書く。データ2（好きな本・映画など）から読み取れる価値観が恋愛にどう表れるかも書いてよい。占い本らしい温かみのある文体だが、内容はこの人専用であること。

[SECTION_3]
「隠された自己・長所」に相当する部分（800字以上）。
【隠された自己】の見出しと、●長所（箇条書きで5つ以上）を必ず含める。データ1〜3から読み取れる「表には出しにくいけれど持っている強み」「周囲が気づきにくい魅力」を具体的に書く。ネガティブな表現は使わず、この人固有の魅力・強み・可能性だけを書くこと。`;
}
